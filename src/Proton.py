...
# ------------------Functions----------------------
def reply(audio):
    print(f"Replying: {audio}")  # Logging the reply for debugging
...
with sr.Microphone() as source:
    r.energy_threshold = 300  # Adjusted threshold
    r.dynamic_energy_threshold = True  # Enable dynamic threshold
...
def record_audio():
    with sr.Microphone() as source:
        ...
        try:
            ...
            print("You said: " + voice_data)  # Debugging statement
...
def respond(voice_data):
    ...
    print("Responding to voice data:", voice_data)
    ...
    if not is_awake:
        if 'wake up' in voice_data:
            is_awake = True
            wish()
        return  # Added return to prevent further execution when bot is asleep
